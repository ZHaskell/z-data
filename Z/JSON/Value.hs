...
--
data Value = Object {-# UNPACK #-} !FlatMap ObjectKeyVal
...
data ObjectKeyVal = ObjectKeyVal
    {-# UNPACK #-} (PrimArray Word8)
    {-# UNPACK #-} Value

instance KeyVal ObjectKeyVal where
    type Key ObjectKeyVal = T.Text
    type Val ObjectKeyVal = Value
    packKeyVal (t, v) =
    unpackKeyVal (ObjectKeyVal k v) =
    compareKeyVal :: (ObjectKeyVal k1 _) (ObjectKeyVal k2 _) =
    compareKey t (ObjectKeyVal k v) =
