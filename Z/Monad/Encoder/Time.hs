...
Description : Encoders for types from time.
...
Encoders for dates and times.
-}

module Z.Data.Encoder.Time
  ( day
  , timeOfDay
  , timeZone
  , utcTime
...
dayTime :: Day -> TimeOfDay64 -> Encoder ()
{-# INLINE dayTime #-}
dayTime d t = day d >> B.word8 LETTER_T >> timeOfDay64 t

timeOfDay64 :: TimeOfDay64 -> Encoder ()
